...
public class TransactionController {
    ...
    private final TransactionDebitService transactionDebitService;
    private final TransactionCreditService transactionCreditService;

    public TransactionController(TransactionService transactionService,
        TransactionDebitService transactionDebitService, TransactionCreditService transactionCreditService) {
